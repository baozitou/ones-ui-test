...
class OnesAgileDevManageElement(object):
    #弹窗是否显示
    ...
    #「我关注的前端研发任务」视图
    # front_end_view = 'xpath=>/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div/div/div/div/div/div/div/div/div[1]/div[1]/div/div[1]'
    #常用报表
...
class OnesAgileDevManagePage(BasePage):
    def __init__(self, driver):
        super(OnesAgileDevManagePage, self).__init__(driver)
        element = OnesAgileDevManageElement()
